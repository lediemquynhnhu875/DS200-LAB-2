...
│   └── bai5_top_related_by_category.pig    # Top 5 từ liên quan theo category
...
pig -x local scripts/bai5_top_related_by_category.pig
```

> Nếu chạy lại, xóa output cũ trước:
> ```bash
...
### Bài 5 — Top 5 từ liên quan theo Category (`bai5_top_related_by_category.pig`)
- Tìm 5 từ liên quan nhất cho mỗi category bằng cách đếm tần suất từ 
- **Output:** `output/bai5_top5_related/`
...
| `05_bai5_related.jpg`   | **Bài 5** — Top 5 từ liên quan nhất                                                  |
